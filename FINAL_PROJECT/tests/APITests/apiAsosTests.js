...
describe('API Testing for ASOS', () => {
    ...
    describe('API location test for "get" ', function () {
        const baseApiUrl = 'https://geolocation.onetrust.com/cookieconsentpub/v1/geo/location'
        let response;
    before(async () => {
    ...
    it('should return status code 201', async () => {
        response = await axios.post('https://www.asos.com/bFeYYCDQshrwi/smVb2D7yI/VNfRM/b7uiwmtGYh/OTsqAg/Egl7RhNq/NH0', {"success": true})
